 ...
 * Use the [YourBooksFragment.newInstance] factory method to
...
class YourBooksFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        yourBooksBinding.bookListRecyclerView.layoutManager = LinearLayoutManager(context)
        val bookListAdapter = BookListAdapter(bookList)
        yourBooksBinding.bookListRecyclerView.adapter = bookListAdapter
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment yourBooksFragment.
         */
